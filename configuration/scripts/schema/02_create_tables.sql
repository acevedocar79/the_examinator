...
-- 
CREATE SEQUENCE SQ_QUESTION_ID NO CYCLE;
CREATE TABLE QUESTION (
    ID_QUESTION INTEGER PRIMARY KEY DEFAULT nextval('SQ_QUESTION_ID'),
    CATEGORY_QUESTION VARCHAR(20) NOT NULL,
...
--
CREATE SEQUENCE SQ_OPTION_QUESTION_ID NO CYCLE;
CREATE TABLE OPTION_QUESTION (
    ID_OPTION INTEGER DEFAULT nextval('SQ_OPTION_QUESTION_ID'),
    ID_QUESTION INTEGER NOT NULL,
    
    ANSWER TEXT NOT NULL,
    IS_A_RESPONSE BOOLEAN DEFAULT false,
    
    CONSTRAINT pk_option_question PRIMARY KEY (ID_OPTION, ID_QUESTION),
    CONSTRAINT fk_question FOREIGN KEY (ID_QUESTION) REFERENCES QUESTION(ID_QUESTION),
    CONSTRAINT unique_answer UNIQUE (ANSWER)
);
